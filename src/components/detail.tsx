  ...
  const recibirValorContador = (nuevoValor: number) => {
    ...
    return (
        ...
        <div className="w-1/2 p-6">
          <img className="w-full" src="./img/340341-3359c763f08b338b2b15680466868435-1024-1024.webp" alt="" />
        ...
        <h1 className="text-4xl font-bold">EL NOMBRE DEL PRODUCTO</h1>
         ...
         <ButtonAmount enviarValorAlPadre={recibirValorContador}></ButtonAmount>
            ...
            <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg shadow-lg ">ENVIAR PRODUCTO</button>
        </section>
